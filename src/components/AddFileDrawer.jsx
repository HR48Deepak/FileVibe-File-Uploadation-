...
//                 className={`w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-blue-500 ${error && !fileName ? 'border-red-500' : 'border-gray-300'}`}
//               />
//             </div>
...
//               type="submit" 
//               disabled={loading}
//               // className="w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 transition-colors shadow-lg active:scale-95"
//               className={`w-full text-white py-3 rounded-xl font-bold transition-colors shadow-lg active:scale-95 ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'}`}
